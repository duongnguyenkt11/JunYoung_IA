...
import com.example.myapplication.databinding.ItemFoodBookmarkRowBinding;
...
public class BookmarkAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemFoodBookmarkRowBinding binding =
                ItemFoodBookmarkRowBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class ContentViewHolder extends BaseViewHolder {
        ...
        ContentViewHolder(ItemFoodBookmarkRowBinding binding, MyCustomEditTextListener myCustomEditTextListener) {
